...
export const placeOrderCOD = async (req, res,next) => {
    try{
        ...
        return res.json(new ApiResponse(200, null, "Order Placed Successfully"))
    }catch(error){
        return next(new ApiError(500, error.message))
    }
}

//get orders userId = /api/order/user
...
//Stripe webhook to verify the Payments Actions: /stripe
export const stripeWebhooks = async(request,response)=>{
    ...
    switch (event.type) {
        case "payment_intent.succeeded":{
            ...
            //update the payment in db as paid
